...
[![Latest release](https://img.shields.io/github/v/release/liberusoftware/module-maintenance-labor-and-time-api?sort=semver)](https://github.com/liberusoftware/module-maintenance-labor-and-time-api/releases/latest) [![Tests](https://github.com/liberusoftware/module-maintenance-labor-and-time-api/actions/workflows/tests.yml/badge.svg?branch=main)](https://github.com/liberusoftware/module-maintenance-labor-and-time-api/actions/workflows/tests.yml)
...
```bash
composer require liberusoftware/module-maintenance-labor-and-time-api
```
...
<a href="https://github.com/liberusoftware/module-maintenance-labor-and-time-api/graphs/contributors">
  <img src="https://contrib.rocks/image?repo=liberusoftware/module-maintenance-labor-and-time-api" alt="Contributors to liberusoftware/module-maintenance-labor-and-time-api">
</a>

[View the full contributors graph](https://github.com/liberusoftware/module-maintenance-labor-and-time-api/graphs/contributors).
